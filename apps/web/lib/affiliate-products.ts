...
export const affiliateProducts: AffiliateProduct[] = [
  ...
  {
    slug: 'ultimea-poseidon-d80-soundbar',
    asin: 'B0DCJG1117',
    affiliateTag: 'lovelytools-21',
    amazonDomain: 'amazon.co.uk',
    ...
    brand: 'ULTIMEA',
    name: 'Poseidon D80 7.1Ch Soundbar with Dolby Atmos, APP Control, Surround Sound System for TV, 4 Wired Surround Speakers, Sound Bar with 6.5" Wireless Subwoofer',
    tagline: 'Four real satellite speakers and a wireless sub — surround sound that comes from behind you, not from an algorithm.',
    description:
      'A 7.1 system rather than a soundbar pretending to be one: three channels in the bar, four separate satellites for front and rear, and a 6.5-inch wireless subwoofer. HDMI eARC handles the TV, and the app offers a 10-band equaliser and 121 presets.',

    images: [
      `/products/ultimea-poseidon-d80-soundbar/1.jpg`,
      `/products/ultimea-poseidon-d80-soundbar/2.jpg`,
      `/products/ultimea-poseidon-d80-soundbar/3.jpg`,
      `/products/ultimea-poseidon-d80-soundbar/4.jpg`,
    ],
    awardBadge: { line1: '#1', line2: 'BEST SELLER' },

    trustBadges: [
      { icon: 'award', label: '#1 Best Seller', sublabel: 'In Hi-Fi Speaker Systems' },
      { icon: 'star', label: '4.3 rating', sublabel: 'From 87 reviews' },
      { icon: 'volume-2', label: '7.1 channels', sublabel: '8 drivers across five units' },
      { icon: 'circle-dot', label: '6.5" subwoofer', sublabel: 'Wireless, down to 35 Hz' },
    ],
    specs: [
      { icon: 'volume-2', label: 'Channels', value: '7.1 — 3 in the bar, 4 satellites, 1 sub' },
      { icon: 'zap', label: 'Peak power', value: '460 W (Amazon lists 500 W)' },
      { icon: 'circle-dot', label: 'Subwoofer', value: '6.5 inch, wireless' },
      { icon: 'gauge', label: 'Frequency response', value: 'From 35 Hz' },
      { icon: 'layers', label: 'Surround speakers', value: '2 front + 2 rear, wired' },
      { icon: 'monitor', label: 'Connections', value: 'HDMI 4K eARC in/out, optical, AUX' },
      { icon: 'sliders', label: 'EQ', value: '121 presets, 10-band, 6 sound modes' },
      { icon: 'ruler', label: 'Recommended room', value: 'Up to 50 m² (538 ft²)' },
    ],
    features: [
      {
        icon: 'volume-2',
        title: 'Actual rear speakers',
        body: 'Two front and two rear satellites sit around the room rather than bouncing sound off your ceiling and hoping. That is the difference between 7.1 and a bar claiming to simulate it.',
      },
      {
        icon: 'layers',
        title: 'Dolby Atmos decoding',
        body: 'Height and object metadata are decoded rather than folded down, with ULTIMEA\'s SurroundX positioning placing effects around the seating area.',
      },
      {
        icon: 'circle-dot',
        title: '6.5-inch wireless sub',
        body: 'The subwoofer connects wirelessly so it can go where the bass works rather than where the cable reaches, and it is quoted down to 35 Hz.',
      },
      {
        icon: 'monitor',
        title: 'HDMI eARC, plus the old inputs',
        body: 'One 4K HDMI in and one out with eARC covers a modern TV and a console, while optical and AUX are still there for older kit.',
      },
      {
        icon: 'sliders',
        title: '121 presets and a 10-band EQ',
        body: 'Six modes — Movie, Music, Voice, Sport, Game and Night — sit alongside a full 10-band equaliser, so dialogue-heavy TV and late-night viewing each get their own setting.',
      },
      {
        icon: 'wifi',
        title: 'App control with OTA updates',
        body: 'The ULTIMEA app handles tuning and settings, and pushes firmware updates over the air rather than leaving the unit on whatever shipped.',
      },
    ],

    pros: [
      '#1 Best Seller in Hi-Fi Speaker Systems, rated 4.3 with 74% five-star reviews',
      'A genuine 7.1 layout with four separate satellites, not virtualised surround',
      'Amazon\'s review summary reports buyers rating sound quality, easy setup and value highly',
      'HDMI eARC alongside optical and AUX, with reported smooth integration with TV, Xbox and Fire TV',
      '10-band EQ and six sound modes, updated over the air through the app',
    ],
    cons: [
      'Amazon states it is usually dispatched within 3 to 7 months — this is not a quick purchase',
      'Amazon\'s review summary reports reliability is mixed, with some buyers describing units that stopped working; 9% of reviews are one star',
      'No DTS decoding — ULTIMEA state this explicitly, so DTS discs and some streams fall back',
      'The surround speakers are wired, and their stands are not included, so plan cable runs before buying',
    ],
    bestFor: [
      'Films and games in a room up to about 50 m², where rear channels genuinely change the experience',
      'Anyone wanting real surround without the cost of separates and a receiver',
      'Households that want dialogue and night modes on tap for everyday TV',
    ],
    notIdealFor: [
      'Anyone who needs it soon, given the three-to-seven-month dispatch estimate',
      'Rooms where cables cannot be run behind the seating position',
      'DTS-heavy disc collections, which this model does not decode',
    ],

    score: 7.8,
    verdict:
      'The specification is unusually honest for the money — four real satellites, a 6.5-inch wireless sub and eARC make this a true 7.1 system rather than a simulation, and reviewers rate the sound. It is scored below the rest of the guide because reliability divides buyers, 9% left one star, and Amazon currently quotes a three-to-seven-month dispatch.',

    faq: [
      {
        q: 'Is this real surround sound or simulated?',
        a: 'Real. Three channels sit in the main bar, four separate satellite speakers cover front and rear positions, and the 6.5-inch subwoofer handles bass — eight drivers across five units, rather than one bar using processing to imply rear channels.',
      },
      {
        q: 'How long will delivery take?',
        a: 'Amazon currently states the item is usually dispatched within 3 to 7 months. That is the listing\'s own estimate rather than a typo, so check the current date on the product page before ordering if you need it soon.',
      },
      {
        q: 'Does it support DTS?',
        a: 'No. ULTIMEA note directly in the listing that the D80 does not support DTS decoding. It handles Dolby Atmos, which covers most streaming content, but a DTS soundtrack on a Blu-ray will not be decoded natively.',
      },
      {
        q: 'What do I need to set it up?',
        a: 'A TV with HDMI eARC is the simplest route, and optical or AUX work with older sets. The subwoofer is wireless, but the four surround speakers are wired to the bar, and speaker stands are not included — so consider where the cables and satellites will sit.',
      },
    ],
  },
];
